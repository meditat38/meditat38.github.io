...
var NodeToyMaterial = _NodeToyMaterial;
__publicField(NodeToyMaterial, "_bindDOMEvents", () => {
});
__publicField(NodeToyMaterial, "_time", { time: 0, deltaTime: 0 });
__publicField(NodeToyMaterial, "_clock", new Clock());
export {
  CubeUVReflectionMapping2 as CubeUVReflectionMapping,
  NodeToyCullMode,
  NodeToyMaterial,
  NodeToyMaterialType,
  NodeToyRenderType
};
//# sourceMappingURL=@nodetoy_three-nodetoy.js.map
